...
public class ModBlocks {
  ...
  public static final DeferredHolder<Block, LootrCopperChestBlock> COPPER_CHEST = REGISTER.register(LootrConstants.COPPER_CHEST.getPath(), () -> new LootrCopperChestBlock(LootrCopperChestBlock.COPPER, LootrConstants.COPPER_CHEST_PROPERTIES));
  public static final DeferredHolder<Block, LootrCopperChestBlock> EXPOSED_COPPER_CHEST = REGISTER.register(LootrConstants.EXPOSED_COPPER_CHEST.getPath(), () -> new LootrCopperChestBlock(LootrCopperChestBlock.EXPOSED, LootrConstants.EXPOSED_COPPER_CHEST_PROPERTIES));
  public static final DeferredHolder<Block, LootrCopperChestBlock> WEATHERED_COPPER_CHEST = REGISTER.register(LootrConstants.WEATHERED_COPPER_CHEST.getPath(), () -> new LootrCopperChestBlock(LootrCopperChestBlock.WEATHERED, LootrConstants.WEATHERED_COPPER_CHEST_PROPERTIES));
  public static final DeferredHolder<Block, LootrCopperChestBlock> OXIDIZED_COPPER_CHEST = REGISTER.register(LootrConstants.OXIDIZED_COPPER_CHEST.getPath(), () -> new LootrCopperChestBlock(LootrCopperChestBlock.OXIDIZED, LootrConstants.OXIDIZED_COPPER_CHEST_PROPERTIES));
  ...
  public static final DeferredHolder<Block, LootrShulkerBoxBlock> SHULKER_BOX = REGISTER.register(LootrConstants.SHULKER_BOX.getPath(), () -> new LootrShulkerBoxBlock(LootrConstants.SHULKER_BOX_PROPERTIES));
