...
public class ModBlocks {
  ...
  public static final DeferredHolder<Block, LootrBarrelBlock> BARREL = REGISTER.register(LootrConstants.LOOTR_BARREL.getPath(), () -> new LootrBarrelBlock(LootrConstants.BARREL_PROPERTIES));
