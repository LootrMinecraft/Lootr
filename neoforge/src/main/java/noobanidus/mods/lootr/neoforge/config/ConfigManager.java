...
public class ConfigManager extends ConfigManagerBase {
  ...
  static {
    ...
    TRAPPED_CUSTOM = COMMON_BUILDER.comment("when true, custom inventories will act like trapped chests when trapped").define("trapped_custom", false);
    COMMON_BUILDER.pop();
    ...
    VANILLA_TEXTURES = CLIENT_BUILDER.comment("set to true to use vanilla textures instead of Lootr special textures. Note: this will prevent previously trapped chests from rendering differently").define("vanilla_textures", false);
