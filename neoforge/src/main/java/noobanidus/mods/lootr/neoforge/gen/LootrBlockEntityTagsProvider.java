...
public class LootrBlockEntityTagsProvider extends IntrinsicHolderTagsProvider<BlockEntityType<?>> {
  ...
  protected void addTags(HolderLookup.Provider provider) {
    ...
    tag(LootrTags.BlockEntity.CONVERT_BLACKLIST)
        ...
        .add(LootrRegistry.getBrushableBlockEntity(), LootrRegistry.getBarrelBlockEntity(), LootrRegistry.getChestBlockEntity(), LootrRegistry.getTrappedChestBlockEntity(), LootrRegistry.getInventoryBlockEntity(), LootrRegistry.getShulkerBlockEntity());
  }
