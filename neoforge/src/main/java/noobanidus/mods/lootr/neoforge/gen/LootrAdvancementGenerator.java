...
public class LootrAdvancementGenerator implements AdvancementSubProvider {
  ...
  public void generate(HolderLookup.Provider arg, Consumer<AdvancementHolder> consumer) {
    AdvancementHolder lootrRoot = Advancement.Builder.advancement().display(Blocks.CHEST, Component.translatable("lootr.advancements.root.title"), Component.translatable("lootr.advancements.root.description"), ResourceLocation.parse("minecraft:textures/block/dark_oak_log.png"), AdvancementType.TASK, false, false, false).addCriterion("always_true", PlayerTrigger.TriggerInstance.tick()).save(consumer, LootrAPI.rl("root"));
    AdvancementHolder one_barrel = Advancement.Builder.advancement().parent(lootrRoot).display(LootrRegistry.getBarrelBlock(), Component.translatable("lootr.advancements.1barrel.title"), Component.translatable("lootr.advancements.1barrel.description"), null, AdvancementType.TASK, true, true, false).addCriterion("opened_barrel", ContainerTrigger.looted(LootrRegistry.getBarrelTrigger())).save(consumer, LootrAPI.rl("1barrel"));
    // 1cart
    AdvancementHolder one_cart = Advancement.Builder.advancement().parent(lootrRoot).display(Items.CHEST_MINECART, Component.translatable("lootr.advancements.1cart.title"), Component.translatable("lootr.advancements.1cart.description"), null, AdvancementType.TASK, true, true, false).addCriterion("opened_cart", ContainerTrigger.looted(LootrRegistry.getCartTrigger())).save(consumer, LootrAPI.rl("1cart"));
    // 1chest
    AdvancementHolder one_chest = Advancement.Builder.advancement().parent(lootrRoot).display(LootrRegistry.getChestBlock(), Component.translatable("lootr.advancements.1chest.title"), Component.translatable("lootr.advancements.1chest.description"), null, AdvancementType.TASK, true, true, false).addCriterion("opened_chest", ContainerTrigger.looted(LootrRegistry.getChestTrigger())).save(consumer, LootrAPI.rl("1chest"));
    // 1shulker
    ...
    // 25loot
    AdvancementHolder twentyfive_loot = Advancement.Builder.advancement().parent(ten_loot).display(Blocks.EMERALD_BLOCK, Component.translatable("lootr.advancements.25loot.title"), Component.translatable("lootr.advancements.25loot.description"), null, AdvancementType.TASK, true, true, false).addCriterion("opened_25", LootedStatTrigger.looted(25)).save(consumer, LootrAPI.rl("25loot"));
    // 50loot
    AdvancementHolder fifty_loot = Advancement.Builder.advancement().parent(twentyfive_loot).display(Blocks.DIAMOND_BLOCK, Component.translatable("lootr.advancements.50loot.title"), Component.translatable("lootr.advancements.50loot.description"), null, AdvancementType.TASK, true, true, false).addCriterion("opened_50", LootedStatTrigger.looted(50)).save(consumer, LootrAPI.rl("50loot"));
    // 100loot
    ...
    Advancement.Builder.advancement().parent(one_chest).display(Items.ENCHANTED_GOLDEN_APPLE, Component.translatable("lootr.advancements.social.title"), Component.translatable("lootr.advancements.social.description"), null, AdvancementType.CHALLENGE, true, true, true).addCriterion("opened_chest", AdvancementTrigger.completed(one_chest.id())).addCriterion("opened_barrel", AdvancementTrigger.completed(one_barrel.id())).addCriterion("opened_cart", AdvancementTrigger.completed(one_cart.id()))./*addCriterion("opened_shulker", AdvancementTrigger.completed(one_shulker.id())).*/save(consumer, LootrAPI.rl("social"));
  }
}
