...
public class LootrAdvancementGenerator implements AdvancementProvider.AdvancementGenerator {
  ...
  public void generate(HolderLookup.Provider arg, Consumer<AdvancementHolder> consumer, ExistingFileHelper existingFileHelper) {
    ...
    AdvancementHolder archaeologist = Advancement.Builder.advancement().parent(pot)
        ...
        .addCriterion("got_pot", AdvancementTrigger.completed(pot.id()))
    ...
    AdvancementHolder ten_loot = Advancement.Builder.advancement().parent(one_chest)
        ...
        .addCriterion("opened_10", LootedStatTrigger.looted(10))
    ...
    AdvancementHolder twentyfive_loot = Advancement.Builder.advancement().parent(ten_loot)
        ...
        .addCriterion("opened_25", LootedStatTrigger.looted(25))
    ...
    AdvancementHolder fifty_loot = Advancement.Builder.advancement().parent(twentyfive_loot)
        ...
        .addCriterion("opened_50", LootedStatTrigger.looted(50))
    ...
    Advancement.Builder.advancement().parent(fifty_loot)
        ...
        .rewards(AdvancementRewards.Builder.loot(LootrAPI.TROPHY_REWARD))
    ...
    Advancement.Builder.advancement().parent(one_chest)
        ...
        .addCriterion("opened_cart", AdvancementTrigger.completed(one_cart.id()))./*addCriterion("opened_shulker", AdvancementTrigger.completed(one_shulker.id())).*/save(consumer, LootrAPI.rl("social"), existingFileHelper);
