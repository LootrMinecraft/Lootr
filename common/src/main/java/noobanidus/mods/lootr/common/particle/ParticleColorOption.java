package noobanidus.mods.lootr.common.particle;
...
public record ParticleColorOption(ParticleType<?> type, int color1, int color2, boolean rainbow) implements ParticleOptions {
  ...
  private static MapCodec<ParticleColorOption> codec (ParticleType<ParticleColorOption> type) {
    return RecordCodecBuilder.mapCodec(instance ->
      instance.group(Codec.INT.fieldOf("color1").forGetter(ParticleColorOption::color1), Codec.INT.fieldOf("color2").forGetter(ParticleColorOption::color2), Codec.BOOL.fieldOf("rainbow").forGetter(ParticleColorOption::rainbow)).apply(instance, (c1, c2, r) -> new ParticleColorOption(type, c1, c2, r))
    );
  }
