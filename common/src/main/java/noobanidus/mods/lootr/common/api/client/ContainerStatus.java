...
public enum ContainerStatus {
  ...
  public enum Type {
    ...
    public static final IntFunction<ContainerStatus.Type> BY_ID = ByIdMap.continuous(ContainerStatus.Type::ordinal, values(), ByIdMap.OutOfBoundsStrategy.WRAP);
    public static final StreamCodec<ByteBuf, ContainerStatus.Type> STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, ContainerStatus.Type::ordinal);
  }
  ...
  public static Message getMessage(ContainerStatus status, ContainerStatus.Type type, int remainingValue) {
