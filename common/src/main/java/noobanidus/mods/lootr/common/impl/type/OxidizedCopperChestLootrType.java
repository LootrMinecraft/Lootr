...
public class OxidizedCopperChestLootrType implements ILootrType {
  @Override
  public String getName() {
    return BuiltInLootrTypes.TYPE_OXIDIZED_COPPER_CHEST;
  }
  ...
  public void callback() {
    BuiltInLootrTypes.OXIDIZED_COPPER_CHEST = this;
  }
}
