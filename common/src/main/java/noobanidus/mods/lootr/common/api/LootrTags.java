...
public class LootrTags {
  public static class Blocks extends LootrTags {
    ...
    public static final TagKey<Block> CONVERT_SAND = tag("convert/sands");
    public static final TagKey<Block> CONVERT_GRAVEL = tag("convert/gravels");
    ...
    public static final TagKey<Block> BLOCKS = tag("blocks");
  ...
  public static class Items extends LootrTags {
    ...
    public static TagKey<Item> BLOCKS = tag("blocks");
