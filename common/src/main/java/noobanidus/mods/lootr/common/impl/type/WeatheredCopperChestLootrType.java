...
public class WeatheredCopperChestLootrType implements ILootrType {
  @Override
  public String getName() {
    return BuiltInLootrTypes.TYPE_WEATHERED_COPPER_CHEST;
  }
  ...
  public void callback() {
    BuiltInLootrTypes.WEATHERED_COPPER_CHEST = this;
  }
}
