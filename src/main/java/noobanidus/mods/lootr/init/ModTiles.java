...
public class ModTiles {
  ...
  public static TileEntityType<SpecialLootBarrelTile> SPECIAL_LOOT_BARREL = TileEntityType.Builder.create(SpecialLootBarrelTile::new, Blocks.BARREL).build(null);
