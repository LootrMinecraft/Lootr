...
public class ModItems {
  public static final BlockItem CHEST = new BlockItem(ModBlocks.CHEST, new Item.Properties().setId(LootrRegistry.CHEST_ITEM_KEY));
  public static final BlockItem BARREL = new BlockItem(ModBlocks.BARREL, new Item.Properties().setId(LootrRegistry.BARREL_ITEM_KEY));
  public static final BlockItem TRAPPED_CHEST = new BlockItem(ModBlocks.TRAPPED_CHEST, new Item.Properties().setId(LootrRegistry.TRAPPED_CHEST_ITEM_KEY));
