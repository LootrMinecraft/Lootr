...
public class LootrClientNetworkingInit {
  public static void register() {
    ClientPlayNetworking.registerGlobalReceiver(PacketContainerStatus.TYPE, (payload, context) -> {
    ...
    ClientPlayNetworking.registerGlobalReceiver(PacketAreaEntitySync.TYPE,
        (payload, context) -> {
          context.client().execute(() -> {
            ...
            for (BlockEntity be : ((AccessorMixinLevelRenderer) lr).lootr$getGlobalBlockEntities()) {
