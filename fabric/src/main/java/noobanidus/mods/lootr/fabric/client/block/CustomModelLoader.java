...
public class CustomModelLoader implements ModelLoadingPlugin, ModelResolver, ILootrFabricModelProvider.Acceptor {
  ...
  private static final Map<Identifier, CustomBarrelModelInfo> BARREL_MODEL_MAP = new HashMap<>();
  private static final Map<Identifier, CustomBrushableModelInfo> BRUSHABLE_MODEL_MAP = new HashMap<>();
  ...
  @Override
  public void acceptCustomModel(Identifier modelName, Identifier modelOpenedLocation, Identifier modelUnopenedLocation, @Nullable Identifier modelVanillaLocation) {
    BARREL_MODEL_MAP.put(modelName, new CustomBarrelModelInfo(modelOpenedLocation, modelUnopenedLocation, modelVanillaLocation));
  }

  @Override
  public void acceptBrushableModel(Identifier modelName, Identifier opened, Identifier stage0, Identifier stage1, Identifier stage2, Identifier stage3) {
    BRUSHABLE_MODEL_MAP.put(modelName, new CustomBrushableModelInfo(opened, stage0, stage1, stage2, stage3));
  }

  record CustomBarrelModelInfo (Identifier opened, Identifier unopened, @Nullable Identifier vanilla) {
  }

  record CustomBrushableModelInfo (Identifier opened, Identifier stage0, Identifier stage1, Identifier stage2, Identifier stage3) {
  }
}
