...
public class BarrelModelLoader implements ModelLoadingPlugin, ModelResolver {
  ...
  // Model references
  private static final Identifier LOOTR_BARREL_MODEL_UNOPENED = LootrAPI.rl("block/lootr_barrel");
  private static final Identifier LOOTR_BARREL_MODEL_OPENED = LootrAPI.rl("block/lootr_barrel_open");
