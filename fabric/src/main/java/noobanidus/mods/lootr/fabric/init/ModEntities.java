...
public class ModEntities {
  ...
  public static void registerEntities() {
    ...
    ITEM_FRAME = Registry.register(BuiltInRegistries.ENTITY_TYPE, LootrProperties.ITEM_FRAME, EntityType.Builder.<LootrItemFrame>of(LootrItemFrame::new, MobCategory.MISC)
        .sized(0.5F, 0.5F)
        .eyeHeight(0.0F)
